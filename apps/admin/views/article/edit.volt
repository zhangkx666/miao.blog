...
<div id="vo" class="clearfix m-t-20">
    <div class="article-form">
        <form class="layui-form ajax-form" method="post" action="/admin/article/{{article.id}}/update">
...
<textarea id="hide_markdown" style="display: none">{{ article.markdown }}</textarea>
<script>
    ...
    layui.use(['form', 'markdown'], function () {
        ...
        var vo = new Vue({
            ...
            ready: function () {
                this.markdown_content = document.getElementById('hide_markdown').value;
            },
            watch: {
