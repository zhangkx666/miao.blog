...
;!function (a, b) {
    ...
    h.anim = ["layer-anim", "layer-anim-01", "layer-anim-02", "layer-anim-03", "layer-anim-04", "layer-anim-05", "layer-anim-06"], g.pt.config = {
        ...
        if (a) {
            ...
            d.css({height: b + e + g + 12}), d.find("iframe").css({height: b})
        }
        ...
        f.style(a, {
            ...
            left: parseFloat(d[3]),
            overflow: "visible"
        }), b.find(".layui-layer-max").removeClass("layui-layer-maxmin"), b.find(".layui-layer-min").show(), "page" === b.attr("type") && b.find(h[4]).show(), e.rescollbar(a);layer.iframeAuto(a); // zhangkx 2016.4.21
    }, f.full = function (a) {
        var b, g = c("#" + h[0] + a);
